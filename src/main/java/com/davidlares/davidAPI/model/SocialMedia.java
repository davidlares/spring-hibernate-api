package com.davidlares.davidAPI.model;
...
import javax.persistence.GenerationType; // la de org.hibernate.annotations (Deprecated)
...
@Entity	// Esto es una anotacion que ataca la clase
@Table(name="social_media") // Esta anotacion ataca la clase
public class SocialMedia implements Serializable {
	
	@Id
	@Column(name="id_social_media")
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	// esto ultimo indica que idSocialMedia va a ser PK Autoincrementable
